...
<div class="container mx-auto px-4 py-6">
    <div class="bg-white shadow rounded p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <!-- Kelola Siswa -->
            <a href="{{ route('admin.edit-role') }}" class="bg-blue-100 hover:bg-blue-200 text-blue-800 p-4 rounded shadow text-center">
                <h3 class="font-semibold text-lg mb-2">Verivikasi Guru</h3>
                <p class="text-sm">Lihat dan kelola data guru.</p>
            </a>
            <a href="{{ route('guru.create') }}" class="bg-blue-100 hover:bg-blue-200 text-blue-800 p-4 rounded shadow text-center">
                <h3 class="font-semibold text-lg mb-2">Add Data Guru</h3>
                <p class="text-sm">Lihat dan kelola data guru.</p>
            </a>
            ...
            <a href="{{ route('siswa.addSiswa') }}" class="bg-blue-100 hover:bg-yellow-200 text-yellow-800 p-4 rounded shadow text-center">
                <h3 class="font-semibold text-lg mb-2">Management Data Siswa</h3>
